(()=>{let e={galleryId:"",images:[],currentImage:0,modalImages:[],totalImages:0},t=null;function l(){return t||(window.YT&&window.YT.Player?Promise.resolve(window.YT):t=new Promise((e,t)=>{window.onYouTubeIframeAPIReady=()=>{e(window.YT)};let l=document.createElement("script");l.id="iframe-api",l.src="https://www.youtube.com/iframe_api",l.onerror=()=>{t(Error("Failed to load YouTube IFrame API"))};let a=document.getElementsByTagName("script")[0];a.parentNode.insertBefore(l,a)}))}var a=({selector:t=".gallery"}={})=>{if(document.querySelectorAll(t).length>0){let a,r,i,s;a=document.querySelectorAll(t),r=[],a.forEach(t=>{var l;let a,i=t.id,s=Object.create(e);s.images=t.querySelectorAll("img");let o=(l=s.images,a=[],l.forEach((e,t)=>{var l,r,i,s;let o,n,d;a.push((l=e,r=t,l.setAttribute("data-imagekey",r),o=l.getAttribute("data-sg-youtubeid"),n=(i=l).getAttribute("data-sg-src")?i.getAttribute("data-sg-src"):i.src,d=(s=l).getAttribute("data-sg-desc")?s.getAttribute("data-sg-desc"):s.alt,((e,t,l,a,r=null)=>{let i="",s="";return null!==r&&(i=`data-youtubeid="${r}"`,s=`<div class="simple-gallery-play-icon">
    ...
    </li>`})(r,n,l.alt,d,o)))}),`    <ul data-gallery-id="${i}" class="gallery-list">
      ${a.join("")}
    </ul>`);r.push(o)}),i=r.join(""),s=`
